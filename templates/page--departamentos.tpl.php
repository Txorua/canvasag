...
<div id="wrapper" class="clearfix">
  ...
  <section id="page-title"
          ...
          style="background-image: url('<?php print($variables['imagen_departamento']); ?>'); background-size: cover;"
          data-stellar-background-ratio="0.3">
    <div class="container clearfix">
      <h1 style="color: #AD9B17 !important"><?php print $title; ?></h1>
    </div>
  </section>
